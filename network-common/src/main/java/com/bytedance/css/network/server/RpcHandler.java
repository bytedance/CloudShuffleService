...
import com.bytedance.css.network.client.StreamCallbackWithID;
import com.bytedance.css.network.client.TransportClient;

/**
 * Handler for sendRPC() messages sent by {@link com.bytedance.css.network.client.TransportClient}s.
 */
public abstract class RpcHandler {
   ...
   * ({@link com.bytedance.css.network.client.StreamCallback#onData(String, ByteBuffer)})
   * will fail the entire channel.  A failure in "post-processing" the stream in
   * {@link com.bytedance.css.network.client.StreamCallback#onComplete(String)} will result in an
