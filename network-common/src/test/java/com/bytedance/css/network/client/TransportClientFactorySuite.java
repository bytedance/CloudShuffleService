...
import com.bytedance.css.network.TestUtils;
...
import com.bytedance.css.network.util.ConfigProvider;
import com.bytedance.css.network.util.JavaUtils;
import com.bytedance.css.network.util.MapConfigProvider;
...
public class TransportClientFactorySuite {
  ...
  private void testClientReuse(int maxConnections, boolean concurrent)
    ...
    configMap.put("css.shuffle.io.numConnectionsPerPeer", Integer.toString(maxConnections));
  ...
  public void closeIdleConnectionForRequestTimeOut() throws IOException, InterruptedException {
    TransportConf conf = new TransportConf("shuffle", new ConfigProvider() {
      ...
      public String get(String name) {
        if ("css.shuffle.io.connectionTimeout".equals(name)) {
